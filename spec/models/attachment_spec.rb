...
describe Attachment do
  ...
  describe '#attached_by' do
    context 'given user' do
      ...
      let(:f_mock) { double }
      let(:attachment_attribute_without_type) do
        {
          'filename' => 'filename',
          'tempfile' => file_mock
        }
      ...
      context 'attachment type is video/mp4' do
        let(:attachment_attribute_with_type_video_mp4) do
          {
      ...
      context 'attachment type is image/png' do
        let(:attachment_attribute_with_type_image_png) do
          {
            **attachment_attribute_without_type,
            'type' => 'image/png'
          }
      ...
      context 'attachment type is image/gif' do
        let(:attachment_attribute_with_type_image_gif) do
          {
            **attachment_attribute_without_type,
            'type' => 'image/gif'
          }
      ...
      context 'attachment type is image/jpeg' do
        let(:attachment_attribute_with_type_image_jpeg) do
          {
            **attachment_attribute_without_type,
            'type' => 'image/jpeg'
          }
      ...
      context 'attachment type is text/plain' do
        let(:attachment_attribute_with_type_text_plain) do
          {
            **attachment_attribute_without_type,
            'type' => 'text/plain'
          }
      ...
      context 'attachment type is text/csv' do
        let(:attachment_attribute_with_type_text_csv) do
          {
            **attachment_attribute_without_type,
            'type' => 'text/csv'
          }
      ...
      context 'attachment type is application/x-tar' do
        let(:attachment_attribute_with_type_application_x_tar) do
          {
            **attachment_attribute_without_type,
            'type' => 'application/x-tar'
          }
        end
        let(:attachment_with_type_text_application_x_tar) do
          Attachment.new attachment_attribute_with_type_application_x_tar
        end
